...
#        print 'chay vo di nan ni ma hic hic'
#        return super(sale_order_line_make_invoice, self).make_invoices(cr, uid, ids, context=context)
...
#                                                              line_ids,
#                                                              context=context)
            loc_id = self.pool.get('stock.location').search(cr, uid, [('is_defect', '=', True)])
            loc_id = loc_id and loc_id[0] or 0
        return loc_id
        ...
        for wizard_claim_line in wizard.claim_line_ids:
            ...
            move_id = move_obj.create(
                ...
                {'name': wizard_claim_line.product_id.name_template,
                 ...
                 'partner_id': partner_id,
                 'brand_id': wizard_claim_line.brand_id.id,
