...
class crea8s_lot_overview_all(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(crea8s_lot_overview_all, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.crea8s.lot.stock.overview_all', 'stock.location', 'addons/crea8s_derick/report/lot_overview_all.rml', parser=crea8s_lot_overview_all,header='internal')
